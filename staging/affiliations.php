...
<div class="row-fluid">
  <div id="mainimage" class="span12">
    <div class="row-fluid">
      <img src="images/heartlandedcenter350.jpg" alt="Heartland Community College Community Education Center" id="mainimage" class="span12" />
    </div>
  </div>
</div>
...
<div class="row-fluid">
    ...
    <div id="affiliations_boxes">
      ...
      <br />
      <div class="row-fluid">
        <a href="#" target="_blank" class="span4">
          <div class="row-fluid affiliate_thumbnail">
            <img src="images/ciel.jpg" />
          </div>
        </a>
        <a href="http://www.cboexpo.com/" target="_blank" class="span4">
          <div class="row-fluid affiliate_thumbnail">
