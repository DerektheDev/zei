  ...
  <article id="content_area" class="span8">
    <div id="about">  
      ...
      <ul class="list-unstyled services" id="lists">
        ...
        <li><i class="fa fa-check"></i> Food manufacturing plants</li>
        <li><i class="fa fa-check"></i> Government facilities</li>
        <li><i class="fa fa-check"></i> Educational institutions</li>
        <li><i class="fa fa-check"></i> Waste management</li>
        <li><i class="fa fa-check"></i> Agricultural</li>
        <li><i class="fa fa-check"></i> Healthcare</li>
	  ...
	  <div class="row-fluid">
	  	...
	  	&nbsp;
			...
			<ul class="thumbnails">
				...
				<li class="col-sm-6 span7">
					<p class="bio-text">As co-founder of Zeller Electric, David is a key decision maker for the company. He holds an associates degree in math and has an IBEW electrical apprenticeship under his belt. He is a member of NECA (board member for 15 years), NFPA, and NJATC, and is chairman of the board for the Joint Apprenticeship Training Committee (JATC).</p>
					
					<p class="bio-text">David has been married for 40 years to his wife, Christine; they have four grown sons and 12 grandchildren. He enjoys boating, riding his motorcycle, and spending time with his family. David is active in his church and is on the Church Leadership Council. </p>
				</li>
				</ul>	  	
			<div class="span1">
		  	&nbsp;
